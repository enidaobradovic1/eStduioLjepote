...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "eStudioLjepote.Mobile.Android.dll" comes first in this list. */
		"eStudioLjepote.Mobile.Android.dll",
		"eStudioLjepote.Mobile.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
