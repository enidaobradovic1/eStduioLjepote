            ...
            if (!MenuPages.ContainsKey(id))
            {
                switch (id)
                {
                    ...
                    case (int)MenuItemType.Profil:
                        MenuPages.Add(id, new NavigationPage(new Profil()));
                        break;
                    case (int)MenuItemType.Usluge:
                        MenuPages.Add(id, new NavigationPage(new PonudePage()));
                        break;
                    case (int)MenuItemType.Proizvodi:
                        MenuPages.Add(id, new NavigationPage(new ProizvodiPage()));
                        break;
                    case (int)MenuItemType.Rezervacija:
                        MenuPages.Add(id, new NavigationPage(new RezervacijeListPage()));
                        break;
